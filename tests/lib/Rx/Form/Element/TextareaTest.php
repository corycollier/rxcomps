...
class Tests_Rx_Form_Element_TextareaTest
    extends Rx_PHPUnit_TestCase
{
    /**
     * test_loadDefaultDecorators()
     *
     * Tests the loadDefaultDecorators method of the Rx_Form_Element_Textarea class
     *
     * @covers Rx_Form_Element_Textarea::loadDefaultDecorators
    ...
    {
        $subject = $this->getBuiltMock('Rx_Form_Element_Textarea', array(
     ...
     * the Rx_Form_Element_Textarea class
     *
     * @return array
     */
...
} // END class Tests_Rx_Form_Element_TextareaTest