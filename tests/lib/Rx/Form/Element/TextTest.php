...
class Tests_Rx_Form_Element_TextTest
    extends Rx_PHPUnit_TestCase
{
    /**
     * test_loadDefaultDecorators()
     *
     * Tests the loadDefaultDecorators method of the Rx_Form_Element_Text class
     *
     * @covers Rx_Form_Element_Text::loadDefaultDecorators
    ...
    {
        $subject = $this->getBuiltMock('Rx_Form_Element_Text', array(
     ...
     * the Rx_Form_Element_Text class
     *
     * @return array
     */
